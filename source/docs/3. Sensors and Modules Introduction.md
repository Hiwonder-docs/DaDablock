...
Connect the motor to controller port S1. Make sure the yellow wire is connected to S, the red wire to 5V, and the brown wire to GND, as shown below:

<img src="../_static/media/chapter_3/section_1/media/image2.png"  class="inline-icon" style="width:500px;" >

### 3.1.4 Test Demo

Once the program has been downloaded and is running, the block motor rotates forward at speed 50 for 2 seconds, then reverses at the same speed for 2 seconds, and finally stops.

### 3.1.5 Program Screenshot

<img src="../_static/media/chapter_3/section_1/media/image3.png"  class="inline-icon" style="width:400px;" >

- The program uses the **Set servo S1 to rotate at speed 50** block because the block motor must be controlled with a PWM signal, and the controller outputs PWM through ports S1-S6. In this example, S1 is used to send the control signal to the block motor.
